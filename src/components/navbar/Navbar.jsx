  ...
  return (
    <>
      <nav className="shadow-md bg-white fixed top-0 left-0 w-full z-50">
        <div className="container mx-auto flex justify-between items-center px-3 py-3">
          ...
          <div className="flex justify-center md:justify-end gap-6 mt-6 md:mt-0 px-4">
            <ul className="flex items-center gap-3">
              {/* Search Box */}
              <li>
                <div className="flex items-center border-[2px] border-[#000] rounded-xl overflow-hidden">
                  <input
                    type="text"
                    placeholder="Search..."
                    className="px-2 py-1 text-[15px] outline-none focus:ring-2 focus:ring-blue-400"
                  />
        ...
        <div
          className={`lg:hidden fixed top-0 right-0 h-full w-3/4 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-40 ${isOpen ? "translate-x-0" : "translate-x-full"
            }`}
        >
